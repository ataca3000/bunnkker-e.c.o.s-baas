...
export default function CheckoutPage() {
    const { cart, siteConfig, createOrder } = useCart();
    ...
    const handleCheckout = async () => {
        if (!clientName.trim() || !clientPhone.trim()) {
            alert("⚠️ Por favor ingresa tu Nombre y Teléfono para poder identificar tu pedido.");
            return;
        }
    ...
    if (isPaid) {
        return (
            <div style={{ minHeight: '85vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', backgroundColor: '#f9f9f9' }}>
                <motion.div
                ...
                >
                    ...
                    <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.5rem', marginBottom: '2rem', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
                        ...
                        <div className="card-sanjose">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                <div
                                    ...
                                    style={{
                                        padding: '1.5rem', border: method === 'delivery' ? '2px solid #0ea5e9' : '2px solid #ddd',
                                        borderRadius: '8px', cursor: hasBulkItems ? 'pointer' : 'not-allowed', backgroundColor: method === 'delivery' ? '#F0F7FF' : '#f9f9f9',
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: '0.75rem', color: '#666' }}>Cero esperas. Almacén alista primero, pagas al recoger en tu lugar asignado.</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                ...
                                {method === 'delivery' && (
                                    <input 
                                        ...
                                        style={{ gridColumn: 'span 2', padding: '12px', border: '1px solid #ddd', borderRadius: '4px' }} 
                                        required 
                                    />
                                )}
                            </div>
                    ...
                    <div>
                        <div className="card-sanjose" style={{ position: 'sticky', top: '20px' }}>
                            ...
                            {method === 'delivery' ? (
                                <div style={{ marginBottom: '2rem' }}>
                                    <div style={{ backgroundColor: '#FFCB05', padding: '1rem', borderRadius: '4px' }}>
                                        <div style={{ fontSize: '0.75rem', fontWeight: 'bold', color: '#0ea5e9' }}>ANTICIPO REQUERIDO (50%)</div>
                                ...
                                <div style={{ marginBottom: '2rem' }}>
                                    <div style={{ backgroundColor: '#0ea5e9', padding: '1rem', borderRadius: '4px', color: 'white' }}>
                                        <div style={{ fontSize: '0.75rem', fontWeight: 'bold' }}>PAGO EN VENTANILLA / CAJÓN</div>
                            ...
                            >
                                {isProcessing ? (
                                    <>
                                        <Loader2 className="animate-spin" size={20} /> ENCOLANDO...
                                    </>
