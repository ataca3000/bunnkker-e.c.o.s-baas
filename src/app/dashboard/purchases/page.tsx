...
export default function PurchasesDashboard() {
    ...
    const loadOrders = useCallback(async () => {
        ...
        try {
            ...
            if (snap.empty && orders.length === 0) {
                // Firestore connected but no data yet — show empty list (not demo)
                setOrders([]);
            } else {
            ...
            console.warn('[Purchases] Firestore unavailable — using demo data.', err);
            setIsOffline(true);
            setOrders([]);
        } finally {
            setLoading(false);
    ...
    const handleSaveOrder = async () => {
        ...
        try {
            ...
            const saved: PurchaseOrder = { id: docRef.id, ...newOrder };
