...
async function main() {
  ...
  // 7. Patio (Carga/Descarga) -> PIN 6666
  await prisma.user.create({
    data: {
      name: 'Patio / Carga y Descarga',
      pin: '6666',
      role: 'carga_descarga',
      active: true,
    },
  ...
  // 8. Pick Up (Mostrador) -> PIN 7777
  await prisma.user.create({
    data: {
      name: 'Mostrador / Pick Up',
      pin: '7777',
      role: 'pickup',
      active: true,
    },
  ...
  console.log('   - 6666: Carga y Descarga');
  console.log('   - 7777: Pick Up');
