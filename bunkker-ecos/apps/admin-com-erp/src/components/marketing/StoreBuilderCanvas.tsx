...
export default function StoreBuilderCanvas() {
        ...
        if (pageData.layout && pageData.layout.length > 0) {
            ...
            if (currentPage === 'inicio') {
                setLayout([
                    ...
                    { id: 'catalog', type: 'catalog', order: 1, visible: true, settings: { columns: 3, categoryFilter: 'all', showRatings: true, borderRadius: 24, backgroundColor: 'transparent' } },
                    { id: 'about', type: 'about', order: 2, visible: true, settings: { titleText: 'CONÓCENOS', subtitleText: 'Somos una empresa comprometida con la calidad.', imageUrl: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=800&auto=format&fit=crop', backgroundColor: '#ffffff', textColor: '#1e293b' } },
                    { id: 'map', type: 'map', order: 3, visible: true, settings: { titleText: '¿NO ENCUENTRAS LO QUE BUSCAS?', subtitleText: 'Podemos cotizar materiales especiales sobre pedido.', buttonText: 'HABLAR CON UN ASESOR', backgroundColor: '#10172a' } }
                ]);
        ...
        try {
            ...
            uploadTask.on('state_changed', 
                ...
                (error) => {
                    ...
                    alert('Error al subir el archivo. Revisa tu conexión o configuración de Storage.');
            ...
            if (file.size < 800 * 1024) {
                ...
                alert('No se pudo subir a la nube. Para archivos pesados, usa la opción de Insertar URL directa o configura Firebase Storage.');
                setIsUploading(false);
            }
        }
    };
    ...
    const handleApplyToMarket = async () => {
        ...
        } catch { alert('Error al aplicar el diseño.'); } finally { setIsSaving(false); }
    };
