...
import { handleFirestoreError, OperationType } from '@bunkker/core';
...
export default function DeliveryDashboard() {
    ...
    const { location: driverLocation } = useDriverGPS(true);
    
    // MONITOREO EN VIVO extraído al hook useDriverGPS
