...
import { Map, Zap, ChevronRight, User, MapPin, Navigation } from 'lucide-react';
      ...
      <div className="bg-slate-900/40 backdrop-blur-lg rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-white/10 overflow-hidden relative mb-2">
        <div className="h-64 w-full bg-slate-800 relative z-0">
          <iframe 
            ...
            marginHeight={0} 
            marginWidth={0} 
            src={`https://maps.google.com/maps?width=100%25&height=600&hl=en&q=${encodeURIComponent(orders[0].address)}&t=&z=14&ie=UTF8&iwloc=B&output=embed`}
