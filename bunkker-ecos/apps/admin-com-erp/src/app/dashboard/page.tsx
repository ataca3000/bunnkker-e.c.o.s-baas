...
const SuperAdminDashboard = ({
    ...
    formatCurrency, isScannerOpen, setIsScannerOpen, handleAdminScan, firebaseStatus
}: any) => {
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '6px' }}>
                        ...
                        {firebaseStatus === 'offline' ? (
                            <span className="flex items-center gap-1 bg-red-100 text-red-600 px-2 py-0.5 rounded-full text-[10px] font-bold border border-red-200">
                                <CloudOff size={12} /> OFFLINE
                            </span>
                        ) : (
                            <span className="flex items-center gap-1 bg-green-100 text-green-600 px-2 py-0.5 rounded-full text-[10px] font-bold border border-green-200">
